...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=r"D:\TrafficSystem\SmartJianKong\SmartJianKong\yolov5-master\yolov5\data\my_datas", help="cifar10, cifar100, mnist, imagenet, ...")
