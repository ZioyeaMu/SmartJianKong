...
def run(
    ...
    test=False,  # val exports only
    pt_only=False,  # val PyTorch only
...
def test(
    ...
    Args:
        ...
        hard_fail (bool): Raise error on export or val failure if True. Default is False.
...
def parse_opt():
    ...
    Args:
        ...
        val (bool): Test exports only. This is a flag and defaults to False.
    ...
    parser.add_argument("--val", action="store_true", help="val exports only")
    parser.add_argument("--pt-only", action="store_true", help="val PyTorch only")
