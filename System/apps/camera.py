...
class CameraApp(BaseApp):
    ...
    def __init__(self, system, camera_id=0, resolution=(1280, 720), fps=30, white_balance=False):
    ...
    def receive_stream(self, server_ip, server_port, save_to_file=False, filename=None, display=False, fps=None, timeout=10, white_balance=True):
        """连接到TCP图像服务器并立即开始接收流
    ...
    def _client_receive_thread(self, stream_key, client_socket, client_video_writer, client_video_filename, client_save_video, client_video_fps, white_balance=True, display=False):
        """TCP客户端接收线程
